    ...
    return {
        init:function() {
            $("#m_datepicker_1, #m_datepicker_1_validate").datepicker( {
                rtl: mUtil.isRTL(), autoclose: !0, todayHighlight: !0, orientation: "bottom left", templates: t, format: 'yyyy-mm-dd'
            }
            ),
            ...
            $("#m_datepicker_2, #m_datepicker_2_validate").datepicker( {
                rtl: mUtil.isRTL(), autoclose: !0, todayHighlight: !0, orientation: "bottom left", templates: t
            }
            ),
            ...
            $("#m_datepicker_3, #m_datepicker_3_validate").datepicker( {
                rtl: mUtil.isRTL(), todayBtn: "linked", clearBtn: !0, orientation: "bottom right", todayHighlight: !0, templates: t
            }
            ),
