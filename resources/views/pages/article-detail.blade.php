                    ...
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        ...
                        <section class="border shadow p-3 rounded mb-3">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="col-lg-3">
                                    <img src="{{ asset('article/'.$article->image) }}" alt="Holahalo Banner" width="100" height="100">
                                </div>
                                <div class="col-lg-9">
                                    <sup class="text-danger">{{ $article->created_at->format('Y-m-d') }}</sup>
                                    <p>{!! $article->content !!}</p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <sup class="text-success">{{ $article->created_at->diffForHumans() }}</sup>
                                    </div>
                                </div>
                            </div>
                        </section>
