                                    ...
                                    <div class="m-portlet__body">
                                        <div class="row">
                                            <div v-for="item in value.documentation" :key="item.id" class="col-lg-4">
                                                <img :src="`/storage/activity_documentation_guest_extension/${item.file}`" height="100">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export default {
        ...
        return {
            ...
            breadcrumbLink: [
                ...
                },
                {
                    ...
                    path: `/monev/extension/detail/${this.$route.params.id}/guest`
                }
            ],
    ...
    methods: {
        getData() {
            $axios.get(`/admin/extension/monev/detail/guest/${this.$route.params.id}`)
            .then(response => {
