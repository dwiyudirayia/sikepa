...
export default {
        ...
        return {
            ...
            breadcrumbLink: [
                ...
                },
                {
                    ...
                    path: `/monev/extension/activity/${this.$route.params.id}/guest/list`
                },
            ],
            data: [],
        }
    ...
    methods: {
        destroy(id) {
            $axios.delete(`/admin/extension/list/monev/activity/guest/${id}`)
            .then(response => {
                toastr.options = {
                    "closeButton": false,
                    "debug": false,
        ...
        getData() {
            $axios.get(`/admin/extension/list/monev/activity/guest/${this.$route.params.id}`)
            .then(response => {
