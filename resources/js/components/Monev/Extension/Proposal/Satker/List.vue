                            ...
                            <template v-if="data.length">
                                <tr v-for="(value, index) in data" :key="value.id">
                                    ...
                                    <td>
                                        ...
                                        <router-link :to="{name: 'ExtensionResultMonevActivitySatkerEdit', params: { id: value.id }}" class="btn m-btn btn-success btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Edit Kegiatan'">
                                            <span>
...
export default {
        ...
        return {
            ...
            breadcrumbLink: [
                ...
                },
                {
                    ...
                    path: `/monev/extension/activity/${this.$route.params.id}/satker/list`
                },
            ],
            data: [],
        }
    ...
    methods: {
        destroy(id) {
            $axios.delete(`/admin/extension/list/monev/activity/satker/${id}`)
            .then(response => {
                toastr.options = {
                    "closeButton": false,
                    "debug": false,
        ...
        getData() {
            $axios.get(`/admin/extension/list/monev/activity/satker/${this.$route.params.id}`)
            .then(response => {
