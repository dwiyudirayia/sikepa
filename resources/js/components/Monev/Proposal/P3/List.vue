                            ...
                            <template v-if="data.length">
                                <tr v-for="(value, index) in data" :key="value.id">
                                    ...
                                    <td>
                                        ...
                                        <router-link :to="{name: 'ResultMonevActivityGuestEdit', params: { id: value.id }}" class="btn m-btn btn-success btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Nilai Kegiatan'">
                                            <span>
...
export default {
        ...
        return {
            ...
            breadcrumbLink: [
                ...
                },
                {
                    ...
                    path: `/monev/activity/${this.$route.params.id}/guest/list`
                },
            ],
            data: [],
        }
    ...
    methods: {
        destroy(id) {
            $axios.delete(`/admin/list/monev/activity/guest/${id}`)
            .then(response => {
                toastr.options = {
                    "closeButton": false,
                    "debug": false,
        ...
        getData() {
            $axios.get(`/admin/list/monev/activity/guest/${this.$route.params.id}`)
            .then(response => {
