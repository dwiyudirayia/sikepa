...
export default {
        ...
        return {
            ...
            breadcrumbLink: [
                ...
                },
                {
                    ...
                    path: `/monev/activity/${this.$route.params.id}/guest/result`
                },
            ],
            forms: {
    ...
    beforeRouteEnter(to, from, next) {
        $axios.get(`/admin/show/monev/activity/guest/${to.params.id}`)
        .then(response => {
    ...
    methods: {
        store() {
            $axios.post(`/admin/result/monev/activity/guest`, this.forms)
            .then(response => {
                toastr.options = {
                    "closeButton": false,
                    "debug": false,
