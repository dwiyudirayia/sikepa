...
export default {
        ...
        return {
            ...
            breadcrumbLink: [
                ...
                },
                {
                    ...
                    path: `/monev/detail/${this.$route.params.id}/guest/edit`
                },
            ],
        }
    },
    ...
    methods: {
        storeFile() {
            ...
            $axios.post(`/admin/store/file/activity/guest`, formData)
            .then(response => {
                toastr.options = {
                    "closeButton": false,
                    "debug": false,
        ...
        downloadImage(id) {
            window.location.href = `/api/admin/download/image/activity/guest/${id}?token=${localStorage.getItem('token')}`;
        },
        hapusImage(id) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $axios.delete(`/admin/image/activity/guest/${id}`)
                    .then(response => {
                        this.getData();
                    })
                }
        ...
        update() {
            ...
            $axios.put(`/admin/monev/activity/guest/${this.$route.params.id}`, this.forms)
            .then(response => {
                toastr.options = {
                    "closeButton": false,
                    "debug": false,
