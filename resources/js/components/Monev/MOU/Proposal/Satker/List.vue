...
export default {
        ...
        return {
            ...
            breadcrumbLink: [
                ...
                },
                {
                    ...
                    path: `/monev/mou/activity/${this.$route.params.id}/satker/list`
                },
            ],
            data: [],
        }
    ...
    methods: {
        destroy(id) {
            $axios.delete(`/admin/list/monev/activity/satker/${id}`)
            .then(response => {
                toastr.options = {
                    "closeButton": false,
                    "debug": false,
        ...
        getData() {
            $axios.get(`/admin/list/monev/activity/satker/${this.$route.params.id}`)
            .then(response => {
