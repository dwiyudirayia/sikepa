                                            ...
                                            <ul class="m-nav">
                                                <li class="m-nav__item context-menu">
                                                    <a class="m-nav__link" @click="modalEditDeputiPIC">
                                                        ...
                                                        <span class="m-nav__link-text">Tujuan Deputi</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
...
export default {
        ...
        return {
            ...
            breadcrumbLink: [
                ...
                },
                {
                    ...
                    path: `/monev/mou/detail/${this.$route.params.id}/satker`
                }
            ],
    ...
    methods: {
        getData() {
            $axios.get(`/admin/monev/detail/satker/${this.$route.params.id}`)
            .then(response => {
