                                ...
                                <tbody>
                                    <template v-if="tableData.satker.length">
                                        <tr v-for="(value, index) in tableData.satker" :key="value.id">
                                            ...
                                            <td style="vertical-align: middle;">{{ value.mou_from }}</td>
                                            <td style="vertical-align: middle;">
                                                <router-link :to="{name: 'AdendumMonevActivitySatkerCreate', params: { id: value.id }}" class="btn m-btn btn-success btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Tambah Kegiatan'">
                                                    <span>
                                                        <i class="la la-plus"></i>
                                                        <span>Tambah Kegiatan</span>
                                                    </span>
                                                </router-link>
                                                <router-link :to="{name: 'AdendumListMonevActivitySatker', params: { id: value.id }}" class="btn m-btn btn-brand btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Daftar Kegiatan'">
                                                    <span>
                                                        <i class="la la-list"></i>
                                                        <span>Daftar Kegiatan</span>
                                                    </span>
