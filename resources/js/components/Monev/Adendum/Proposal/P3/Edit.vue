...
export default {
        ...
        return {
            ...
            breadcrumbLink: [
                ...
                },
                {
                    ...
                    path: `/monev/adendum/detail/${this.$route.params.id}/guest/edit`
                },
            ],
        }
    },
    ...
    methods: {
        storeFile() {
            ...
            $axios.post(`/admin/adendum/store/file/activity/guest`, formData)
            .then(response => {
                toastr.options = {
                    "closeButton": false,
                    "debug": false,
        ...
        downloadImage(id) {
            window.location.href = `/api/admin/adendum/download/image/activity/guest/${id}?token=${localStorage.getItem('token')}`;
        },
        hapusImage(id) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $axios.delete(`/admin/adendum/image/activity/guest/${id}`)
                    .then(response => {
                        this.getData();
                    })
                }
        ...
        getData() {
            $axios.get(`/admin/adendum/monev/activity/guest/${this.$route.params.id}/edit`)
            .then(response => {
        ...
        update() {
            ...
            $axios.put(`/admin/adendum/monev/activity/guest/${this.$route.params.id}`, this.forms)
            .then(response => {
                toastr.options = {
                    "closeButton": false,
                    "debug": false,
