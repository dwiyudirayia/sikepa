...
export default {
    name: 'AdendumMonevActivityP3Edit',
    data() {
        return {
            forms: {
                title_activity: null,
            ...
            breadcrumbLink: [
                ...
                },
                {
                    ...
                    path: `/monev/adendum/detail/${this.$route.params.id}/satker/edit`
                },
            ],
        }
    },
    ...
    methods: {
        storeFile() {
            ...
            $axios.post(`/admin/adendum/store/file/activity/satker`, formData)
            .then(response => {
                toastr.options = {
                    "closeButton": false,
                    "debug": false,
        ...
        downloadImage(id) {
            window.location.href = `/api/admin/adendum/download/image/activity/satker/${id}?token=${localStorage.getItem('token')}`;
        },
        hapusImage(id) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $axios.delete(`/admin/adendum/image/activity/satker/${id}`)
                    .then(response => {
                        this.getData();
                    })
                }
        ...
        getData() {
            $axios.get(`/admin/adendum/monev/activity/satker/${this.$route.params.id}/edit`)
            .then(response => {
        ...
        update() {
            ...
            $axios.put(`/admin/adendum/monev/activity/satker/${this.$route.params.id}`, this.forms)
            .then(response => {
                toastr.options = {
                    "closeButton": false,
                    "debug": false,
