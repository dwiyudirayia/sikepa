            ...
            <div class="m-portlet__body">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" :class="{'active' : tabs === 3 }"  id="m_tabs_9_3" role="tabpanel" v-if="status_disposition == 12">
                        ...
                        <div class="form-group m-form__group">
                            <label>Draft Final Perpanjangan</label>
                            <div class="input-group">
                        ...
                        <form @submit.prevent="final">
                            <div class="m-form__section m-form__section--first">
                                <div class="m-form__heading">
                                    <h3 class="m-form__heading-title">Nomor Perpanjangan</h3>
                                </div>
...
export default {
        ...
        return {
            ...
            breadcrumbLink: [
                ...
                },
                {
                    ...
                    path: `/extension/submission/cooperation/${this.$route.params.id}/detail/guest`
                },
            ],
            notInDeputi: [],
            deputi: [],
    ...
    methods: {
        storeDraftFile() {
            ...
            $axiosFormData.post('/admin/store/file/guest/draft/extension', formData)
            .then(response => {
        ...
        storeNotulenFile() {
            ...
            $axiosFormData.post('/admin/store/file/guest/notulen/extension', formData)
            .then(response => {
        ...
        downloadDraftFile(id) {
            window.location.href = `/api/admin/download/file/guest/draft/${id}/extension?token=${localStorage.getItem('token')}`;
        },
        downloadNotulenFile(id) {
            window.location.href = `/api/admin/download/file/guest/notulen/${id}/extension?token=${localStorage.getItem('token')}`;
        },
        ...
        extContinue() {
            $axios.post(`/admin/submission/reason/continue/guest/extension`, this.forms)
            .then(response => {
                this.disabled = true;
        ...
        downloadKTP() {
            window.location.href = `/api/admin/download/file/ktp/${this.$route.params.id}/guest/extension?token=${localStorage.getItem('token')}`;
        },
        downloadNPWP() {
            window.location.href = `/api/admin/download/file/npwp/${this.$route.params.id}/guest/extension?token=${localStorage.getItem('token')}`;
        },
        downloadSIUP() {
            window.location.href = `/api/admin/download/file/siup/${this.$route.params.id}/guest/extension?token=${localStorage.getItem('token')}`;
        },
        downloadProposal() {
            window.location.href = `/api/admin/download/file/proposal/${this.$route.params.id}/guest/extension?token=${localStorage.getItem('token')}`;
        },
        downloadAgencyProfile() {
           window.location.href = `/api/admin/download/file/agency/profile/${this.$route.params.id}/guest/extension?token=${localStorage.getItem('token')}`;
        },
        nextTabs() {
        ...
        addDeputiPIC() {
            $axios.post(`/admin/deputi/pic/guest/extension`, {
        ...
        hapusDeputi(id) {
            $axios.delete(`/admin/deputi/pic/guest/extension/${id}`)
            .then(response => {
                this.getData();
                toastr.options = {
                    "closeButton": false,
        ...
        downloadSummary() {
            window.location.href = `/api/admin/download/summary/cooperation/${this.$route.params.id}/guest/extension?token=${localStorage.getItem('token')}`;
        },
        hukum() {
            if(this.$v.draftFile.$invalid && this.$v.notulenFile.$invalid) {
                ...
                $axiosFormData.post(`/admin/submission/cooperation/law/${this.$route.params.id}/guest/extension`, formData)
                .then(response => {
                    toastr.options = {
                        "closeButton": false,
                        "debug": false,
        ...
        downloadFormatWord() {
            axios.get(`/api/admin/download/format/word/${this.$route.params.id}/guest/extension`, {
        ...
        final() {
            if(this.$v.draftFile.$invalid) {
                ...
                $axiosFormData.post(`/admin/submission/cooperation/final/${this.$route.params.id}/guest/extension`, formData)
                .then(response => {
        ...
        getData() {
            $axios.get(`/admin/submission/cooperation/${this.$route.params.id}/detail/guest/extension`)
            .then(response => {
        ...
        approve() {
            $axios.post(`/admin/submission/reason/approve/guest/extension`, this.forms)
            .then(response => {
                this.disabled = true;
                this.text_button = 'Loading ...';
        ...
        reject() {
            $axios.post(`/admin/submission/reason/reject/guest/extension`, this.forms)
            .then(response => {
                this.disabled = true;
                this.text_button = 'Loading ...';
        ...
        generateBarcode(id) {
            $axios.get(`/admin/generate/barcode/${this.$route.params.id}/guest/extension`)
            .then(response => {
                this.getData();
                toastr.options = {
                    "closeButton": false,
