...
export default {
        ...
        return {
            ...
            breadcrumbLink: [
                ...
                },
                {
                    ...
                    path: `/adendum/submission/cooperation/${this.$route.params.id}/detail/guest`
                },
            ],
            notInDeputi: [],
            deputi: [],
    ...
    methods: {
        storeDraftFile() {
            ...
            $axiosFormData.post('/admin/store/file/guest/draft/adendum', formData)
            .then(response => {
        ...
        storeNotulenFile() {
            ...
            $axiosFormData.post('/admin/store/file/guest/notulen/adendum', formData)
            .then(response => {
        ...
        extContinue() {
            $axios.post(`/admin/submission/reason/continue/guest/adendum`, this.forms)
            .then(response => {
                this.disabled = true;
        ...
        downloadKTP() {
            window.location.href = `/api/admin/download/file/ktp/${this.$route.params.id}/guest/adendum?token=${localStorage.getItem('token')}`;
        },
        downloadNPWP() {
            window.location.href = `/api/admin/download/file/npwp/${this.$route.params.id}/guest/adendum?token=${localStorage.getItem('token')}`;
        },
        downloadSIUP() {
            window.location.href = `/api/admin/download/file/siup/${this.$route.params.id}/guest/adendum?token=${localStorage.getItem('token')}`;
        },
        downloadProposal() {
            window.location.href = `/api/admin/download/file/proposal/${this.$route.params.id}/guest/adendum?token=${localStorage.getItem('token')}`;
        },
        downloadAgencyProfile() {
           window.location.href = `/api/admin/download/file/agency/profile/${this.$route.params.id}/guest/adendum?token=${localStorage.getItem('token')}`;
        },
        nextTabs() {
        ...
        addDeputiPIC() {
            $axios.post(`/admin/deputi/pic/guest/adendum`, {
        ...
        hapusDeputi(id) {
            $axios.delete(`/admin/deputi/pic/guest/adendum/${id}`)
            .then(response => {
                this.getData();
                toastr.options = {
                    "closeButton": false,
        ...
        getData() {
            $axios.get(`/admin/submission/cooperation/${this.$route.params.id}/detail/guest/adendum`)
            .then(response => {
        ...
        approve() {
            $axios.post(`/admin/submission/reason/approve/guest/adendum`, this.forms)
            .then(response => {
                this.disabled = true;
                this.text_button = 'Loading ...';
        ...
        reject() {
            $axios.post(`/admin/submission/reason/reject/guest/adendum`, this.forms)
            .then(response => {
                this.disabled = true;
                this.text_button = 'Loading ...';
        ...
        generateBarcode(id) {
            $axios.get(`/admin/generate/barcode/${this.$route.params.id}/guest/adendum`)
            .then(response => {
                this.getData();
                toastr.options = {
                    "closeButton": false,
