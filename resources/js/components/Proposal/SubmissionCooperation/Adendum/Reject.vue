...
export default {
    ...
    methods: {
        getDataYou(page = 1) {
            $axios.get(`/admin/adendum/submission/cooperation/reject/you?page=${page}`)
            .then(response => {
        ...
        getDataSatker(page = 1) {
            $axios.get(`/admin/adendum/submission/cooperation/reject/satker?page=${page}`)
            .then(response => {
        ...
        getDataGuest(page = 1) {
            $axios.get(`/admin/adendum/submission/cooperation/reject/guest?page=${page}`)
            .then(response => {
