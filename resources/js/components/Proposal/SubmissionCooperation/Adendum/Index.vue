                                            ...
                                            <tr v-for="(value, index) in approvalSubmission.data" :key="value.id">
                                                ...
                                                <td>
                                                    ...
                                                    <template v-else-if="value.status_disposition < 9 || value.status_disposition > 9">
                                                        ...
                                                        <router-link v-if="$can('Bagian Kerjasama') && value.status_disposition != 9 && value.status_disposition != 15" :to="{name: 'AdendumProposalSubmissionCooperationYourDetailPreview', params: { id: value.id }}" class="btn m-btn btn-brand btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Untuk Detail Pengajuan'">
                                                            <span>
                                                                <i class="la la-pencil-square"></i>
                                                                <span>Detail Pengajuan</span>
                                                            </span>
                                    ...
                                    <tbody>
                                        <template v-if="guestSubmission.data.length">
                                            <tr v-for="(value, index) in guestSubmission.data" :key="value.id">
                                                ...
                                                <td>
                                                    <template v-if="value.status_disposition === 9 || value.status_disposition === 15">
                                                        <router-link :to="{name: 'AdendumProposalSubmissionCooperationDetailGuest', params: { id: value.id }}" class="btn m-btn btn-success btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Untuk Detail Pengajuan'">
                                                            <span>
                                                                <i class="la la-eye"></i>
                                                                <span>Detail Pengajuan</span>
                                                            </span>
                                                    ...
                                                    <template v-else-if="(value.status_disposition < 9 || value.status_disposition > 9)">
                                                        <router-link v-if="$can('Bagian Kerjasama') == false" :to="{name: 'AdendumProposalSubmissionCooperationDetailGuest', params: { id: value.id }}" class="btn m-btn btn-success btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Untuk Detail Pengajuan'">
                                                            <span>
                                                                <i class="la la-eye"></i>
                                                                <span>Detail Pengajuan</span>
                                                            </span>
                                                        </router-link>
                                                        <router-link v-if="$can('Bagian Kerjasama') && value.status_disposition != 9 && value.status_disposition != 15" :to="{name: 'AdendumProposalSubmissionCooperationYourDetailGuestPreview', params: { id: value.id }}" class="btn m-btn btn-brand btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Untuk Detail Pengajuan'">
                                                            <span>
                                                                <i class="la la-pencil-square"></i>
                                                                <span>Detail Pengajuan</span>
                                                            </span>
...
export default {
    ...
    created() {
        $axios.get(`/admin/adendum/submission/cooperation`)
        .then(response => {
    ...
    methods: {
        ...
        filterGuest() {
            $axios.get('/admin/filter/guest/adendum', {
                params: {
        ...
        resetSatkerSesmenYou() {
            $axios.get('/admin/reset/satker/sesmen/adendum')
            .then(response => {
        ...
        resetSatkerSesmen() {
            $axios.get('/admin/reset/satker/sesmen/approval/adendum')
            .then(response => {
        ...
        resetGuest() {
            $axios.get('/admin/reset/guest/adendum')
            .then(response => {
