                                ...
                                <table class="table m-table m-table--head-bg-brand">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;">Jenis Kerjasama</th>
                                            <th style="vertical-align: middle;">Jenis Permohonan</th>
                                            <th style="vertical-align: middle;">Judul Perpanjangan</th>
                                            <th style="vertical-align: middle;">Negara</th>
                                            <th style="vertical-align: middle;">Instansi</th>
                                            <th style="vertical-align: middle;">Nama Kantor</th>
                                            <th style="vertical-align: middle;">Lama Pengajuan</th>
...
export default {
    ...
    methods: {
        getData() {
            $axios.get(`/admin/extension/submission/cooperation/approve`)
            .then(response => {
        ...
        downloadFileDraft(id) {
            window.location.href = `/api/admin/download/cooperation/success/draft/${id}/extension?token=${localStorage.getItem('token')}`;
        },
        downloadFileDraftGuest(id) {
            window.location.href = `/api/admin/download/cooperation/success/guest/draft/${id}/extension?token=${localStorage.getItem('token')}`;
        }
    }
}
</script>
