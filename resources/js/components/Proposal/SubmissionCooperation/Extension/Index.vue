                                            ...
                                            <tr v-for="(value, index) in youSubmission.data" :key="value.id">
                                                ...
                                                <td>
                                                    ...
                                                    <template v-else-if="value.status_disposition < 9 || value.status_disposition > 9">
                                                        <router-link v-if="$can('Bagian Kerjasama') == false" :to="{name: 'ExtensionProposalSubmissionCooperationDetail', params: { id: value.id }}" class="btn m-btn btn-success btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Untuk Detail Pengajuan'">
                                                            <span>
                                                                <i class="la la-eye"></i>
                                                                <span>Detail Pengajuan</span>
                                                            </span>
                                                        </router-link>
                                                        <router-link v-if="$can('Bagian Kerjasama') && value.status_disposition != 9" :to="{name: 'ExtensionProposalSubmissionCooperationYourDetailPreview', params: { id: value.id }}" class="btn m-btn btn-brand btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Untuk Detail Pengajuan'">
                                                            <span>
                                            ...
                                            <tr v-for="(value, index) in approvalSubmission.data" :key="value.id">
                                                ...
                                                <td>
                                                    ...
                                                    <template v-else-if="value.status_disposition < 9 || value.status_disposition > 9">
                                                        ...
                                                        <router-link v-if="$can('Bagian Kerjasama') && value.status_disposition != 9 && value.status_disposition != 15" :to="{name: 'ExtensionProposalSubmissionCooperationYourDetailPreview', params: { id: value.id }}" class="btn m-btn btn-brand btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Untuk Detail Pengajuan'">
                                                            <span>
                                                                <i class="la la-pencil-square"></i>
                                                                <span>Detail Pengajuan</span>
                                                            </span>
                                        ...
                                        <template v-if="guestSubmission.data.length">
                                            <tr v-for="(value, index) in guestSubmission.data" :key="value.id">
                                                ...
                                                <td>
                                                    ...
                                                    <template v-else-if="(value.status_disposition < 9 || value.status_disposition > 9)">
                                                        <router-link v-if="$can('Bagian Kerjasama') == false" :to="{name: 'ExtensionProposalSubmissionCooperationDetailGuest', params: { id: value.id }}" class="btn m-btn btn-success btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Untuk Detail Pengajuan'">
                                                            <span>
                                                                <i class="la la-eye"></i>
                                                                <span>Detail Pengajuan</span>
                                                            </span>
                                                        </router-link>
                                                        <router-link v-if="$can('Bagian Kerjasama') && value.status_disposition != 9 && value.status_disposition != 15" :to="{name: 'ExtensionProposalSubmissionCooperationYourDetailGuestPreview', params: { id: value.id }}" class="btn m-btn btn-brand btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Untuk Detail Pengajuan'">
                                                            <span>
                                                                <i class="la la-pencil-square"></i>
                                                                <span>Detail Pengajuan</span>
                                                            </span>
...
export default {
    ...
    created() {
        $axios.get(`/admin/extension/submission/cooperation`)
        .then(response => {
    ...
    methods: {
        filterSatkerSesmenYou() {
            $axios.get('/admin/filter/satker/sesmen/extension', {
                params: {
        ...
        filterSatkerSesmen() {
            $axios.get('/admin/filter/satker/sesmen/approval/extension', {
                params: {
        ...
        filterGuest() {
            $axios.get('/admin/filter/guest/extension', {
                params: {
        ...
        resetSatkerSesmenYou() {
            $axios.get('/admin/reset/satker/sesmen/extension')
            .then(response => {
        ...
        resetSatkerSesmen() {
            $axios.get('/admin/reset/satker/sesmen/approval/extension')
            .then(response => {
        ...
        resetGuest() {
            $axios.get('/admin/reset/guest/extension')
            .then(response => {
