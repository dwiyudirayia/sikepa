                                    ...
                                    <tbody>
                                        <template v-if="youSubmission.data.length">
                                            <tr v-for="(value, index) in youSubmission.data" :key="value.id">
                                                ...
                                                <td>
                                                    <router-link :to="{name: 'ExtensionProposalSubmissionCooperationYourDetailPreview', params: { id: value.id }}" class="btn m-btn btn-brand btn-sm  m-btn--icon m-btn--pill icon-only" v-tooltip.top="'Untuk Detail Pengajuan'">
                                                        <span>
