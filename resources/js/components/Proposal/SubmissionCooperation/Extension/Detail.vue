        ...
        <div class="m-portlet">
            ...
            <div class="m-portlet__body">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="m_tabs_9_2" :class="{'active' : tabs === 2 }" role="tabpanel" v-if="status_disposition == 11">
                        <div class="form-group m-form__group row">
...
export default {
        ...
        return {
            ...
            breadcrumbLink: [
                ...
                },
                {
                    ...
                    path: `/extension/submission/cooperation/${this.$route.params.id}/detail`
                },
            ],
            deputi: [],
            nomor: [''],
    ...
    methods: {
        ...
        storeDraftFile() {
            ...
            $axiosFormData.post('/admin/store/file/draft/extension', formData)
            .then(response => {
        ...
        storeNotulenFile() {
            ...
            $axiosFormData.post('/admin/store/file/notulen/extension', formData)
            .then(response => {
        ...
        downloadDraftFile(id) {
            window.location.href = `/api/admin/download/file/draft/${id}/extension?token=${localStorage.getItem('token')}`;
        },
        downloadNotulenFile(id) {
            window.location.href = `/api/admin/download/file/notulen/${id}/extension?token=${localStorage.getItem('token')}`;
        },
        ...
        extContinue() {
            $axios.post(`/admin/submission/reason/continue/extension`, this.forms)
            .then(response => {
                this.disabled = true;
        ...
        downloadProposal() {
            window.location.href = `/api/admin/download/file/proposal/${this.$route.params.id}/extension?token=${localStorage.getItem('token')}`;
        },
        downloadAgencyProfile() {
            window.location.href = `/api/admin/download/file/agency/profile/${this.$route.params.id}/extension?token=${localStorage.getItem('token')}`;
        },
        showModalFile() {
            $('#file').modal('show');
        },
        ...
        getData() {
            $axios.get(`/admin/submission/cooperation/${this.$route.params.id}/detail/extension`)
            .then(response => {
        ...
        approve() {
            $axios.post(`/admin/submission/reason/approve/extension`, this.forms)
            .then(response => {
                this.disabled = true;
                this.text_button = 'Loading ...';
        ...
        reject() {
            $axios.post(`/admin/submission/reason/reject/extension`, this.forms)
            .then(response => {
                this.disabled = true;
                this.text_button = 'Loading ...';
        ...
        generateBarcode(id) {
            $axios.get(`/admin/generate/barcode/${this.$route.params.id}/extension`)
            .then(response => {
                this.getData();
                toastr.options = {
                    "closeButton": false,
