    ...
    data() {
        return {
            ...
            breadcrumbLink: [
                ...
                {
                    id: 2,
                    label: 'Edit Background Login',
                    path: `/background/login/${this.$route.params.id}/edit`
                },
            ],
            forms: {
                image: null,
    ...
    methods: {
        ...
        update() {
            ...
            if(this.$v.forms.$invalid) {
                ...
                $axios.post(`/admin/photo/login/${this.$route.params.id}`, formData)
                .then(response => {
                    toastr.options = {
                        "closeButton": false,
                        "debug": false,
                    ...
                    toastr.success(`Berhasil Update Background Login`);
