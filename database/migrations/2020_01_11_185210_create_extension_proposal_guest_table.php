...
class CreateExtensionProposalGuestTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('extension_proposal_guest', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('extension_proposal_guest');
    }
}
