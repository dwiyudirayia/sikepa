...
class ApprovalOldSubmissionCooperationActivity extends Model
{
    ...
    protected $fillable = ['created_by','approval_old_submission_cooperation_id','implementation_of_activity_reports','activity_result','year','budget','target','achievements','field_trip_information','evaluation','recomendation'];
